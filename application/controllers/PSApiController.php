...
class PSApiController extends CI_Controller {
	...
	public function api(){
	    ...
	    $this->load->datatable_template('api/psapiPage', $data);
	}
    ...
    public function get_product(){		
		...
		if($products){
			foreach($products as $prod){
				...
				$CIBRegistrationCertificate = $prod->cibno;
				$LicenseNumber = $prod->mlno;
				...
				$uomId = $prod->uomid;
				$weight = $prod->net_w;
				$this->saveProductMaster($applicationid,$productCode,$manufacturerName,$MarketedBy,$CIBRegistrationCertificate,$LicenseNumber,
				$SupplierName,$ItemCategoryID,$categoryName,$SubCategoryID,$subCategoryName,$ItemID,$productName,$brandName,$uomId,$weight,$id);
			}
		}
	}

	public function saveProductMaster($applicationid,$productCode,$manufacturerName,$MarketedBy,$CIBRegistrationCertificate,$LicenseNumber,
				$SupplierName,$ItemCategoryID,$categoryName,$SubCategoryID,$subCategoryName,$ItemID,$productName,$brandName,$uomId,$weight,$id){
	    $response = '';	    
		...
		$postData = array(
            ...
            "CIBRegistrationCertificate"=> $CIBRegistrationCertificate,
