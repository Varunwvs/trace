...
<div class="container-fluid">
    <div class="card" >
        <div class="card-block tab-icon"> 
            <h3>Products</h3>
            <form action="<?php echo base_url(); ?>tpkkisaanapi_post" method="post" name="upload_excel" enctype="multipart/form-data">
    ...
    <div class="card" >
        <div class="card-block tab-icon"> 
            <h3>Primary Label</h3>
            <form action="<?php echo base_url(); ?>tpkkisaanapi_batch_post" method="post" name="upload_excel" enctype="multipart/form-data">
            <!--<form action="<?php echo base_url(); ?>" method="post" name="upload_excel" enctype="multipart/form-data">-->
            <!-- <input type="file" name="file" id="file" required=""> -->
                <div class="row">
                    <div class="col-md-12">
    ...
    <div class="card hidden" >
        <div class="card-block tab-icon"> 
            <h3>Containers</h3>
            <form action="<?php echo base_url(); ?>tpsave_secondary_container_detail" method="post" name="upload_excel" enctype="multipart/form-data">
            <!--<form action="<?php echo base_url(); ?>" method="post" name="upload_excel" enctype="multipart/form-data">-->
