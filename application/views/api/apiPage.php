...
<div class="card" >
 ...
 <h3>Products</h3>
<form action="<?php echo base_url(); ?>kkisaanapi_post" method="post" name="upload_excel" enctype="multipart/form-data">
...
<div class="card" >
    <div class="card-block tab-icon"> 
 <h3>Primary Label</h3>
<form action="<?php echo base_url(); ?>kkisaanapi_batch_post" method="post" name="upload_excel" enctype="multipart/form-data">
<!--<form action="<?php echo base_url(); ?>" method="post" name="upload_excel" enctype="multipart/form-data">-->
