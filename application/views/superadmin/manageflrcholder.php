                ...
                <span class="info-box-number">
                    <?php
                        ...
                        foreach($com->result() as $cm){
                          $cid[]=$cm->id;
                          $pcinfo = $this->db->select('count(*) as pcount')->from('fertilizerproduct')->where_in('c_id', $cid)->get();
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php
                        $bcinfo = $this->db->select('count(*) as bcount')->from('fertilizerbatch')->where_in('c_id', $cid)->get();
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php
                        $pscinfo = $this->db->select('count(*) as pscount')->from('fertilizerbatchserial')->where_in('cid', $cid)->get();
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php
                        $sccinfo = $this->db->select('count(*) as sscount')->from('fertilizercontainer')->where_in('cid', $cid)->get();
                ...
                <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 table-responsive text-sm">
                        <table id="dtFlrcholder" class="table table-striped table-bordered nowrap" style="width:100%;">
