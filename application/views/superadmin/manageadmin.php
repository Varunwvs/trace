            ...
            <div class="card">
                <div class="card-header bg-primary" id="dttable">
                    ...
                    <div class="card-header-right">
                      <a class="mr-3 text-white" role="button" href="adminadd"><i class="fa-solid fa-plus"></i> Add New Admin</a>
                    </div>
                </div>
                <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 table-responsive text-sm">
                        <table id="dtAdmin" class="table table-striped table-bordered nowrap" style="width:100%;">
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          <div class="modal-header bg-green shadow-sm mb-2">
            <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="nav-icon fa-solid fa-user-tie"></i> Admin Details</h1>
