                ...
                <span class="info-box-number">
                    <?php
                        ...
                        foreach($com->result() as $cm){
                          $cid[]=$cm->id;
                          $pcinfo = $this->db->select('count(*) as pcount')->from('microirrigationproduct')->where_in('c_id', $cid)->get();
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php
                        $bcinfo = $this->db->select('count(*) as bcount')->from('microirrigationbatch')->where_in('c_id', $cid)->get();
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php
                        $pscinfo = $this->db->select('count(*) as pscount')->from('microirrigationbatchserial')->where_in('cid', $cid)->get();
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php
                        $sccinfo = $this->db->select('count(*) as sscount')->from('microirrigationcontainer')->where_in('cid', $cid)->get();
          ...
          <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-primary" id="dttable">
                    <h5>Micro Irrigation</h5>
                    <p class="m-0 p-0">List of Companies</p>            
                    <div class="card-header-right">
                    <a class="mr-3 text-white" role="button" href="rcholderadd"><i class="fa-solid fa-plus"></i> Add New RC Holder</a>
                    </div> 
                </div>
                <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 table-responsive text-sm">
                        <table id="dtMircholder" class="table table-striped table-bordered nowrap" style="width:100%;">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form id="editRcForm" method="post" action="SuperAdminController/incrcTotalcount">
            <div class="modal-body">            
              <div class="row editModal">
                <div class="col-12">
                  <div class="form-group mb-3">
                    <label for="totalcount" class="">Total Product Count</label>
                    <select class="form-control" name="rctotalcount" id="rctotalcount">
    ...
    <div class="modal fade" id="editQr" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form id="editQrForm" method="post" action="SuperAdminController/incrcQrQuantity">
            <div class="modal-body">            
