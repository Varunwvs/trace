                ...
                <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 text-sm">                        
                        <form id="userForm" action="SuperAdminController/addAdmin" method="post">
                            <div class="row">
                                <div class="col-6">
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="cname" id="cname" placeholder="Admin Name">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="slug" id="slug" placeholder="Admin Slug">
                                        <div class="input-group-append">
                                        <div class="input-group-text bg-gray">
                                            <span class="fas fa-user"></span>
                                        </div>
