        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Active : <span id="pcount"></span></span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number hidden">Deleted : <span id="dbcount"></span></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Serials</span>
                <span class="info-box-number">Primary : <span id="ccount"></span></span>
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <a href="farmingactivitymanage">
                  <span class="info-box-text text-black">Farming Activity</span>
                </a>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <a href="productmanage">
                    <span class="info-box-text text-black">Product Management</span>
                </a>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <a href="sourcing">
                    <span class="info-box-text text-black">Sourcing</span>
                </a>
              </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <a href="warehousemanage">
                      <span class="info-box-text text-black">Warehouse Ops</span>
                  </a>
                  </div>
              <!-- /.info-box-content -->
            </div>
