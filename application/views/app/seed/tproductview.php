              ...
              <div class="card">    
                <div class="card-header bg-primary" id="dttable">
                    ...
                    <div class="card-header-right">
                        ...
                        <?php else : ?>
                            <a class="mr-3 text-white" role="button" href="tproductedit?id=<?php echo $row->id ?>"><i class="fa-solid fa-edit"></i> Edit Product Info</a>
                        <?php endif ?>
                    </div>
                </div>            
            ...
            <?php if($count != 0): ?>
              ...
              <div class="card">    
                <div class="card-header bg-primary" id="dttable">
                    ...
                    <div class="card-header-right">
                        <?php if($api_sent == '1'): ?>
                    <a class="mr-3 text-white" role="button" href="batchentry?id=<?php echo $row->id ?>&upc=<?php echo $row->p_code ?>"><i class="fa-solid fa-plus"></i> Add New Batches</a>
                        <?php else: ?>
                    <!-- <div class="mr-3 text-warning"> Please send the product details using API to agriculture department then create the batches</div> -->
                    <a class="mr-3 text-white" role="button" href="batchentry?id=<?php echo $row->id ?>&upc=<?php echo $row->p_code ?>"><i class="fa-solid fa-plus"></i> Add New Batches</a>
