            ...
            <div class="card">                
                <div class="card-block tab-icon">
                    <div class="row"> 
                      ...
                      <form id="formEditSourcing" method="post" action="SeedController/editSourcing"  enctype="multipart/form-data">
                      <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="sid" id="sid" value="<?php echo $_GET['id'] ?>">
                                </div>
                            </div> 
                            <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" placeholder="" id="edit_lot_reference_no" name="lot_reference_no" aria-describedby="button-addon1" readonly="true">
                              ...
                              <div class="row sourcing-row">
                                  ...
                                  <div class="col-md-2">
                                      <div class="form-group">
                                          ...
                                          <select class="form-control" name="raw_material_id" id="edit_raw_material_id">
                                  ...
                                  <div class="col-md-2">
                                      <div class="form-group">
                                          ...
                                          <select class="form-control" name="uom" id="edit_uom">
                                  ...
                                  <div class="col-md-2">
                                      <div class="form-group">
                                          ...
                                          <input type="date" class="form-control" name="date_of_sourcing" id="edit_date_of_sourcing">
                                      </div>
                                  </div>
                                  <div class="col-md-2">
                                      <div class="form-group">
                                          ...
                                          <input type="hidden" class="form-control" name="grn_file" id="edit_file" >
