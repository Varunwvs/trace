                ...
                <div class="card-header bg-primary" id="dttable">
                    ...
                    <div class="card-header-right">
                        ...
                        <?php
                            ...
                            $pdcount = $this->db->select('count(*) as pcount')->from('seedproduct')
                            ->where(array('c_id'=> $_SESSION['comid'], 'status'=>'1'))->get();
                                ...
                                if($pcount===$_SESSION['comtotprd']){
                                    ...
                                    echo '<a class="mr-3 text-white" role="button" href="tproductentry"><i class="fa-solid fa-plus"></i> Add New Product</a>';
                                }
                            }else{
                                echo '';
                            }                            
                ...
                <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 table-responsive text-sm">
                        <table id="tdtProduct" class="table table-striped table-bordered nowrap" style="width:100%;">
