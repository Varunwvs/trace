                ...
                <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 text-sm">
                        <form id="formRawMaterialEdit" method="post" action="SeedController/editRawMaterial">
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="hidden" name="r_id" id="rid" value="<?php echo $_GET['id'] ?>">
                                  </div>            
                            </div>
                        </div>
                          ...
                          <div class="row" id="rawMaterialsContainer">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="raw_material" id="edit_raw_material">
                                </div>
                            </div>
