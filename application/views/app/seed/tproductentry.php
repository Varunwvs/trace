                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-select select2" data-bs-placeholder="Select" name="uom" id="uom">
                                                        <option value="0|Choose one">Choose Unit</option>
                                                        <?php foreach($units as $row):?>
                                                            <option value="<?php echo $row->uomid.'|'.$row->uomname;?>"><?php echo ucwords($row->uomname);?></option>
                                                        <?php endforeach;?>                                  
                                                    </select> 
                                            ...
                                            <div class="col-md-3" id="uomdiv">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" class="form-control" name="net_w" id="net_w"  placeholder=""  tabindex="-1">
                                                </div>
                                            </div> 
                                            <div class="col-md-3">
                                                <div class="form-group">
