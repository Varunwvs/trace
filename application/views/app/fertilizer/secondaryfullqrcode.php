...
$pdf->SetTitle('Secondary QR Code');
$pdf->SetSubject('Secondary QR Code');
...
$bnfo = $this->db->select('batch_no')->from('fertilizerbatch')->where('id', $id)->get();
...
$pnfo = $this->db->select('p_name')->from('fertilizerproduct')->where('id', $pid)->get();
