...
$id = $_GET['id'];
/*Serial Information*/
$sinfo = $this->db->select('sbsid, batch_id, serialno, cid,alias')->from('fertilizerbatchserial')->where('sbsid', $id)->get();
...
/*Batch Information*/
$binfo = $this->db->select('id, c_id, pid, p_code, batch_no, s_no_qty, mfd_date, exp_date')->from('fertilizerbatch')->where(array('id'=> $batch_id, 'c_id'=>$cid))->get();
