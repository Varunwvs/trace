...
<?php
    ...
    api_response, onlyprimary')->from('fertilizerproduct')->where(array('id'=>$id, 'c_id'=>$cid))->get();
                ...
                <div class="card-header bg-primary" id="dttable">
                    ...
                    <div class="card-header-right">
                      <?php if($row->api_sent!='1'): ?>
                        <a class="mr-3 text-white" role="button" href="productedit?id=<?php echo $row->id ?>"><i class="fa-solid fa-edit"></i> Edit Product Info</a>                        
                      <?php endif ?>
                    </div>
                </div>            
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row hidden">
                                    ...
                                    <label class="form-label col-6 p-2 text-primary"><?php echo strtoupper($row->formulation) ?></label>
                                </div>
                                <div class="row hidden">
                                    <label class="form-label col-6 bg-sky p-2">C.I.B & RC Reg. No.</label>
                                    <label class="form-label col-6 p-2 text-primary"><?php echo strtoupper($row->cibno) ?></label>
                                </div>
                                <div class="row hidden">
                                    <label class="form-label col-6 bg-sky p-2">Mfg. Licence No.</label>
                                    <label class="form-label col-6 p-2 text-primary"><?php echo strtoupper($row->mlno) ?></label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                            ...
                            ->where( array('cid'=>$_SESSION['comid']) )->get();
                                ...
                                if($pcount===$qr_quantity){
                                    ...
                                    if($row->api_sent !=1){
                                        ...
                                        echo '<a class="mr-3 text-white" role="button" href="flbatchentry?id='.$row->id.'&upc='.$row->p_code.'"><i class="fa-solid fa-plus"></i> Add New Batches</a>';
                                    }
                                }
                            }else{
