                        ...
                        <div class="card-block tab-icon">
                            <div class="row"> 
                                <div class="col-12 text-sm">
                                    <form id="formProduct" method="post" action="FertilizerController/addProduct">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="appid" id="appid" value="fl">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row mb-3 hidden">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="cibno" id="cibno" placeholder="Formulation">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">Mfg. Licence No.</label>
                                                    <input type="text" class="form-control" name="mlno" id="mlno" placeholder="Formulation">
                                                </div>
                                            </div>
                                        </div>
