                        ...
                        <div class="card-block tab-icon">
                            <div class="row"> 
                                <div class="col-12 text-sm">
                                    <form id="formProduct" method="post" action="TarpaulinController/addProduct">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="appid" id="appid" value="AP">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label" id="uomlbl">Number of Pieces / Pack *</label>
                                         ...
                                         <div class="row mb-3">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">CM/L Number</label>
                                                    <input type="text" class="form-control" name="cml" id="cml" placeholder="CM/L Number">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">CM_L_BIS_Number</label>
                                                    <input type="text" class="form-control" name="cmlbis" id="cmlbis" placeholder="CM_L_BIS_Number">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">License Number</label>
                                                    <input type="text" class="form-control" name="licno" id="licno" placeholder="License Number">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">GSM</label>
                                                    <input type="text" class="form-control" name="gsm" id="gsm" placeholder="GSM">
                                                </div>
                                            </div>
                                        </div>
