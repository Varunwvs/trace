...
//product info
$pinfo = $this->db->select('name, marketed_by, itemcategory, subcategory, p_code, p_name, b_name, unit_w, net_w, c_id')->from('tarpaulinproduct')->where(array('id'=>$pid,'c_id'=>$cid))->get();
