                        ...
                        <?php
                            ...
                            ->where(array('c_id'=> $_SESSION['comid'], 'status'=>'1'))->get();
                                ...
                                if($pcount===$_SESSION['comtotprd']){
                                    echo "Please contact Admin to get product count.";
                                }else{
                                    echo '<a class="mr-3 text-white" role="button" href="tpproductentry"><i class="fa-solid fa-plus"></i> Add New Product</a>';
                                }
                            }else{
                                echo '';
                            }                            
                ...
                <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 table-responsive text-sm">
                        <table id="dtProduct" class="table table-striped table-bordered" style="width:100%;">
