...
$bid=0;
//batch info
$btinfo = $this->db->select('id, c_id, pid, p_code, batch_no, s_no_qty, mfd_date, exp_date')->from('tarpaulinbatch')
...
net_w, c_id, cml, cmlbis, licno, gsm')->from('tarpaulinproduct')->where(array('id'=>$pid,'c_id'=>$cid))->get();
...
//serial info
$sinfo = $this->db->select('count(*) as scount,sbsid, batch_id, serialno, cid')->from('tarpaulinbatchserial')
