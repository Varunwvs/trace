            ...
            <?php if($count != 0): ?>
              ...
              <div class="card">    
                <div class="card-header bg-primary" id="dttable">
                    <h5>Batch Details</h5>                                
                    <div class="card-header-right">
                        <!--Validation for qrcodes -->
                        <?php if($row->api_sent !=1) : ?>
                      <p class="text-warning">Please send the product details using API to agriculture department then create the batches</p>
                      <?php else : ?>
                      <a class="mr-3 text-white" role="button" href="tpbatchentry?id=<?php echo $row->id ?>&upc=<?php echo $row->p_code ?>"><i class="fa-solid fa-plus"></i> Add New Batches</a>
                        <?php endif ?>
                    </div>
                </div>            
