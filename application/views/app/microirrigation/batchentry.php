                ...
                <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 text-sm">
                        <form id="formBatch" method="post" action="MicroirrigationController/addBatch">
                          <div class="row">
                            <div class="col-md-6 hidden">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="netw" id="netw" value="<?php echo $_GET['nw'] ?>">
                            ...
                            <div class="col-md-6 hidden">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="mfgdate" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" name="mfgdate" id="mfgdate" data-target="#mfgdate">
                            ...
                            <div class="col-md-6">
                                <label class="form-label text-white col-md-12">....</label>
