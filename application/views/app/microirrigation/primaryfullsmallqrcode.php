...
$bid=0;
//batch info
$btinfo = $this->db->select('id, c_id, pid, p_code, batch_no, s_no_qty')
->from('microirrigationbatch')->where(array('id'=> $id, 'c_id'=>$cid))->get();
...
->from('microirrigationbatchserial')->where('batch_id', $brow->id)->get();
