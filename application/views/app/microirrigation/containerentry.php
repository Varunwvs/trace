<div class="content-wrapper bg-sky">
    ...
    $binfo = $this->db->select('sb.*,sp.id as pid,sp.p_name,sp.net_w,sp.unit_w,sp.p_code')
            ->from('microirrigationbatch sb')
            ->join('microirrigationproduct sp','sp.id = sb.pid')
                ...
                <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 text-sm">
                        <form id="formContainer" method="post" action="MicroirrigationController/addContainer">
