                        ...
                        <div class="card-block tab-icon">
                            <div class="row"> 
                                <div class="col-12 text-sm">
                                    <form id="formProduct" method="post" action="MicroirrigationController/addProduct">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="appid" id="appid" value="MI">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4" id="uomdiv">
                                                <div class="form-group">
                                                    <label class="form-label" id="uomlbl">Length per bundle/Number of pipes/pack *</label>
                                         ...
                                         <div class="row mb-3">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="cml" id="cml" placeholder="CML">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">CM L BIS Number</label>
                                                    <input type="text" class="form-control" name="cmlbis" id="cmlbis" placeholder="CM L BIS Number">
                                                </div>
                                            </div>
                                            <div class="col-md-4 hidden">
                                                <div class="form-group">
                                                    <label class="form-label">Licence No.</label>
                                                    <input type="text" class="form-control" name="licno" id="licno" placeholder="Licence No.">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <?php if($_SESSION['comid']==='337' || $_SESSION['comid']==='24'): ?>
                                        <div class="row" style="border-top:1px solid #e6e6e6; border-bottom:1px solid #e6e6e6">
                                            <div class="col-md-12 p-2">
                                                <a id="greenlabel" style="cursor: pointer;font-weight: 700;"> 
                                                    <i class="fas fa-plus"></i> Add Additional Lablel Information <i class="fas fa-caret-down"></i>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row glabel mt-3 hidden">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">Spacing Centimeter(cm):</label>
                                                    <input type="number" class="form-control" name="spacingcm" id="spacingcm"  placeholder="Spacing Centimeter(cm)">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">Diameter:</label>
                                                    <input type="text" class="form-control" name="diameter" id="diameter"  placeholder="Diameter">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">Wall Thickness (MM/MIL):</label>
                                                    <input type="text" class="form-control" name="wallthick" id="wallthick"  placeholder="Wall Thickness (MM/MIL)">
                                                </div>
                                            </div>                                            
                                        </div>
                                        ...
                                        <div class="row glabel mt-3 hidden">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">Net Quantity(Coil Length):</label>
                                                    <input type="text" class="form-control" name="netquantity" id="netquantity"  placeholder="netquantity">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">Discharge:</label>
                                                    <input type="text" class="form-control" name="discharge" id="discharge"  placeholder="Discharge">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row glabel mt-3 hidden">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="usp" id="usp"  placeholder="Unit Sales Price">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label">Maximum Retail Price:</label>
                                                    <input type="number" class="form-control" name="mrp" id="mrp"  placeholder="Maximum Retail Price">
                                                </div>
                                            </div>                                         
                                        </div>
                                        <?php endif ?>
