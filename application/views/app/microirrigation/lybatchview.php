                ...
                <div class="card-block tab-icon">
                    ...
                    <div class="tab-content mt-5">
                        <div class="tab-pane fade show active" id="primary"> 
                            <div class="row">
                                <div class="col-6">
                                    <div class="btn-group1" style="position: absolute;top: 0;left:18rem;right: 0;bottom: 0;z-index: 1000;">
                                        <a href="milybatchxsmallqrcode?id=<?php echo $_GET['id'] ?>&cid=<?php echo $_SESSION['comid'] ?>" target="_blank" style="cursor:pointer;"><button type="button" class="btn btn-warning btn-xs"><i class="fas fa-qrcode"></i> XSmall Qrcode</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="row"> 
