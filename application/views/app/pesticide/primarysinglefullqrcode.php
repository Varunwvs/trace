...
$cid = $_GET['cid'];
/*Serial Information*/
$sinfo = $this->db->select('sbsid, batch_id, serialno, cid')->from('pesticidebatchserial')->where('sbsid', $id)->get();
...
/*Batch Information*/
$binfo = $this->db->select('id, c_id, pid, p_code, batch_no, s_no_qty, mfd_date, exp_date')->from('pesticidebatch')->where(array('id'=> $batch_id, 'c_id'=>$_GET['cid']))->get();
