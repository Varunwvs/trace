                                ...
                                <div class="col-6">
                                    <div class="btn-group1" style="position: absolute;top: 0;left: 10px;right: 0;bottom: 0;z-index: 1000;">
                                        ...
                                        <?php $pub = $this->db->select('public_page')->from('users')->where('id', $_SESSION['comid'])->get(); 
                                          ...
                                          if($public_page === '1'){
                                            echo '<a class="" href="pspublicpageqrcode?id= '.$_GET['id'].'&cid='.$_SESSION['comid'].'" target="_blank" style="cursor:pointer;"><button type="button" class="btn btn-success btn-xs"><i class="fas fa-qrcode"></i> Public QRCode</button></a>
