                            ...
                            <div class="row"> 
                                <div class="col-12 text-sm">
                                    <form id="formProduct" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-4">                                                
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="" id="upc" name="p_code" aria-describedby="button-addon1" readonly="true" tabindex="-1">
                                        ...
                                        <div class="row glabel hidden mt-3">
                                            <div class="col-md-4">
                                                <div class="form-group">
