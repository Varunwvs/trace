...
$pdf->SetTitle('1x1 inch Label');
$pdf->SetSubject('1x1 inch Label');
...
// for( ; $i < $scount ; $i++)
// {       
$srinfo = $this->db->select('alias')->from('pesticidebatchserial')->where('batch_id', $brow->id)->get();
...
$pdf->Output('PR_XS_'.$marketedby.'_'.$pname.'_'.$batch_no.'.pdf', 'I');