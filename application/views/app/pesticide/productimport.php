            ...
            <div class="card-block tab-icon">
                <div class="row"> 
                    <div class="col-12 text-sm">
                        ...
                        <a href="<?php echo base_url() ?>PesticideBulkImport/sample_csv" class="btn btn-info btn-sm pull-right"><i class="fa fa-download"></i> Download sample File</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-block tab-icon">
                        <div class="row"> 
                            ...
                            <h4 class="page-title">Upload File</h4>    
                                <form action="<?php echo base_url(); ?>PesticideBulkImport/import" method="post" name="upload_excel" enctype="multipart/form-data">
