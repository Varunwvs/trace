...
<?php
    ...
    api_response, onlyprimary')->from('publicproduct')->where(array('id'=>$id, 'c_id'=>$cid))->get();
            ...
            <?php if($count != 0): ?>
              ...
              <div class="card">    
                <div class="card-header bg-primary" id="dttable">
                    <h5>Batch Details</h5>                                
                    <div class="card-header-right">
                      <a class="mr-3 text-white" role="button" href="ppsbatchentry?id=<?php echo $row->id ?>&upc=<?php echo $row->p_code ?>"><i class="fa-solid fa-plus"></i> Add New Batches</a>
                    </div>
                </div>            
                  <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 table-responsive text-sm">
                        ...
                        <table id="dtPBatch" class="table table-striped table-bordered nowrap" style="width:100%;">
