            ...
            <?php if($count != 0): ?>
              ...
              <div class="card">    
                <div class="card-header bg-primary" id="dttable">
                    ...
                    <div class="card-header-right">
                      <?php if($row->api_sent !=1) : ?>
                      <p class="text-warning">Please send the product details using API to agriculture department then create the batches</p>
                      <?php else : ?>
                      <a class="mr-3 text-white" role="button" href="psbatchentry?id=<?php echo $row->id ?>&upc=<?php echo $row->p_code ?>"><i class="fa-solid fa-plus"></i> Add New Batches</a>
                      <?php endif ?>
                    </div>
                </div>            
