...
//product info
$pinfo = $this->db->select('name, marketed_by, itemcategory, subcategory, p_code, p_name, b_name, unit_w, net_w, c_id, formulation, cibno, mlno')->from('publicproduct')->where(array('id'=>$pid,'c_id'=>$cid))->get();
...
->from('publicbatch pb')
->join('publicbatchserial pbs', 'pbs.batch_id=pb.id')
