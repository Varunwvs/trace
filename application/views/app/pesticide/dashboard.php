          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Deleted : <span id="dpcount"></span></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Secondary : <span id="dccount"></span></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <?php if($_SESSION['level']==='3' && $_SESSION['comcat']==="5" && 
