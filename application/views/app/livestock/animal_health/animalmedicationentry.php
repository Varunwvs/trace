            ...
            <div class="card">                
                <div class="card-block tab-icon">
                    <div class="row"> 
                      ...
                      <form id="animalMedicationForm" method="post" action="LiveStockManagementController/addAnimalMedication">
                                <div class="row">
                                    <!-- Animal ID -->
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Medication Duration</label>
                                            <input type="text" class="form-control" name="medication_duration">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
