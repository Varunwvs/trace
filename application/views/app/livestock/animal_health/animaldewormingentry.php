            ...
            <div class="card">                
                <div class="card-block tab-icon">
                    <div class="row"> 
                      ...
                      <form id="animalDewormingForm" method="post" action="LiveStockManagementController/addAnimalDeworming">
                                <div class="row">
                                    <!-- Animal ID -->
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Deworming Type</label>
                                            <input type="text" class="form-control" name="deworming_type">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Next Deworming Due Date</label>
                                            <input type="date" class="form-control" name="next_deworming_due">
                                        </div>
                                    </div>
