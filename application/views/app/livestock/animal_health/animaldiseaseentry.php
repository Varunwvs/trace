            ...
            <div class="card">                
                <div class="card-block tab-icon">
                    <div class="row"> 
                      ...
                      <form id="animalDiseaseForm" method="post" action="LiveStockManagementController/addAnimalDisease">
                                <div class="row">
                                    <!-- Animal ID -->
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="disease_symptoms">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="disease_diagnosis">
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Disease Treatment Given</label>
                                            <input type="text" class="form-control" name="disease_treatment">
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Disease Isolation</label>
                                            <input type="text" class="form-control" name="disease_isolation">
                                        </div>
                                    </div>
