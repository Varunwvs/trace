            ...
            <div class="card">                
                <div class="card-block tab-icon">
                    <div class="row"> 
                      ...
                      <form id="animalVeterinaryForm" method="post" action="LiveStockManagementController/addAnimalVeterinary">
                                <div class="row">
                                    <!-- Animal ID -->
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Veterinary Visit Date</label>
                                            <input type="date" class="form-control" name="vet_visit_date">
                                        </div>
                                    </div>
