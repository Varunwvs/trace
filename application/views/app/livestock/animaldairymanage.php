...
<div class="modal fade" id="milkProductionModal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    ...
                    <tr><th>Milk Yield</th><td id="milk_yield"></td></tr>
                    <!-- <tr><th>Milking Time</th><td id="milking_time"></td></tr>
                    <tr><th>Fat %</th><td id="fat_percentage"></td></tr>
                    <tr><th>SNF %</th><td id="snf_percentage"></td></tr>
                    <tr><th>Contamination</th><td id="contamination"></td></tr> -->
                    <tr><th>Storage & Distribution</th><td id="storage_distribution"></td></tr>

                    <tr><th>Lactation Period</th><td id="lactation_period"></td></tr>
                    <!-- <tr><th>Milk Sales Revenue</th><td id="milk_sales_revenue"></td></tr> -->
                </table>
            </div>
