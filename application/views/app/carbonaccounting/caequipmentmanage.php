                ...
                <div class="card-header bg-primary" id="dttable">
                    ...
                    <div class="card-header-right">
                        ...
                        <?php
                            ...
                            echo '<a class="mr-3 text-white" role="button" href="caequipmententry"><i class="fa-solid fa-plus"></i> Add Data</a>';
                ...
                <div class="card-block tab-icon">
                    <div class="row"> 
                      <div class="col-12 table-responsive text-sm">
                        <table id="dtCaEquipment" class="table table-striped table-bordered nowrap" style="width:100%;">
