...
class ProductModel extends CI_Model
{
    ...
    public function countFiltered($postData){
        $this->_get_datatables_query($postData);
        $this->db->where(array('c_id'=>$this->cid,'status'=>'1','is_trace'=>0));
        $query = $this->db->get();
    ...
    function addProduct(){
        ...
        $pid = isset($p_name[0]) ? $p_name[0] : null;        
        $pname = isset($p_name[1]) ? $p_name[1] : null;
    ...
    function editProduct(){
        ...
        'sub_category'=>$edit_sub_category, 'p_name'=>$edit_p_name, 'b_name'=>$edit_b_name, 
    ...
    public function get_products(){
            ...
            $this->db->select('id,p_name')->from('seedproduct');
            return $this->db->get()->result();
