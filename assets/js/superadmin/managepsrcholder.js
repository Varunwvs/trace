$(document).ready(function(){
    //Data Table Function
    var dtPsrcholder = $('#dtPsrcholder').DataTable({
        "paging": true,
        "lengthChange": true,
        "searching": true,
        "ordering": true,
        ...
        "ajax": "SuperAdminController/dtPsrcholder",
        "order": [] 
    });//Datatable View
    ...
    $(document).on('click', '#update_rcpublic', function(e){ 
      var memberid = $(this).data('id');
      SwalPublic(memberid);
      e.preventDefault();
   });
   ...
   Swal.fire({
     ...
     preConfirm: function() {
        return new Promise(function(resolve) {                
           $.ajax({
           url: 'SuperAdminController/pubRcstatus',
           type: 'POST',
           ...
           .done(function(response){
               ...
               $('#dtPscompany').DataTable().ajax.reload();
           })
           .fail(function(){
      ...
      preConfirm: function() {
         return new Promise(function(resolve) {                
            ...
            .done(function(response){
                ...
                $('#dtPsrcholder').DataTable().ajax.reload();
            })
            .fail(function(){
             swal.fire('Oops...', 'Something went wrong !', 'error');
            });
