$(document).ready(function(){
    //Data Table Function
    var dtRcholder = $('#dtRcholder').DataTable({
        "paging": true,
        "lengthChange": true,
        "searching": true,
        "ordering": true,
        ...
        "ajax": "SuperAdminController/dtRcholder",
        "order": [] 
    });//Datatable View
  ...
  function SwalUpdate(memberid){  
      ...
      preConfirm: function() {
         return new Promise(function(resolve) {                
            ...
            .done(function(response){
                ...
                $('#dtRcholder').DataTable().ajax.reload();
            })
            .fail(function(){
   ...
   function viewiMember(id = null) {
  if(id) {   
    $.ajax({
      url: 'SuperAdminController/getComrinfo',
      type: 'post',
      data: {member_id : id},
      dataType: 'json',
      success:function(response) {
        $('#comname').html(response.name); 
        $('#prdcount').html(response.pcount);
        $('#bthcount').html(response.bcount);
        $('#pqrcount').html(response.prcount);
        $('#sqrcount').html(response.srcount); 
      }
    });
  } else{
    alert("Error : Refresh the page again");
