$(document).ready(function(){
    ...
    var dtAnimalVeterinary = $('#dtAnimalVeterinary').DataTable({
        "processing": true,
        "serverSide": true,
        "ordering": true,
        "responsive": true,
        "columnDefs": [{ targets: [0], className: 'dt-center valign dt-w3' },
                        ...
                        { targets: [2,3,4,5,6], className: 'dt-center valign dt-w20' }],
        dom: 'Bfrtip',
          buttons: [
        ...
        "order": [],
          ...
          "ajax": {
              "url": "LiveStockManagementController/dtAnimalVeterinary/",
              "type": "POST"
          },
    });
