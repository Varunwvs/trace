          ...
          $.each(response,function(index,data){
            ...
            $.ajax({
                ...
                success: function(response){     
                    if(suid==='1' && itid==='43'){
                        $('#net_w').empty();
                        $('#net_w').append('<option value="10" selected>10</option>\
                        ...
                        $('#net_w').empty();
                        $('#net_w').append('<option value="100" selected>100</option>\
                    ...
                    else if(suid==='1' && (itid==='24' || itid==='26' || itid==='47' || itid==='54' || itid==='59' || itid==='67' || itid==='68' || itid==='74' || itid==='77' || itid==='78' || itid==='81')){
                        $('#net_w').empty();
                        $('#net_w').append('<option value="50" selected>50</option>\
                        <option value="100">100</option>\
                        <option value="250">250</option>\
                        <option value="500">500</option>\
                        <option value="1000">1000</option>');
                        ...
                        $('#net_w').empty();
                        $('#net_w').append('<option value="60" selected>60</option>\
                    ...
                    else if(suid==='6' && (itid==='5')){
                        $('#net_w').empty();
                        $('#net_w').append('<option value="50" selected>50</option>\
                        <option value="100">100</option>');
                        $('#net_w').attr("style", "pointer-events: all;");
                    }
                    else if(suid==='1' && (itid==='38' || itid==='80')){
                        $('#net_w').empty();
                        $('#net_w').append('<option value="80" selected>80</option>\
                        <option value="100">100</option>\
                    ...
                    else if(suid==='6' && itid==='7'){
                        $('#net_w').empty();
                        $('#net_w').append('<option value="2.5" selected>2.5</option>\
