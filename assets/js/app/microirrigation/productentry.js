...
$('#p_category').change(function(){ 
    ...
    id= ids[0];
    $.ajax({
        url : 'MicroirrigationController/getItemSubCategory',
        method : "POST",
        data : {id: id},
        async : true,
        dataType : 'json',
...
$('#sub_category').change(function(){ 
    ...
    id= ids[0];
    $.ajax({
        url : 'MicroirrigationController/getItem',
        method : "POST",
        data : {id: id},
        async : true,
        dataType : 'json',
...
$('#p_name').change(function(){ 
    ...
    subid= subids[0];
    $.ajax({
        url : 'MicroirrigationController/getUomids',
        method : "POST",
    ...
    $.ajax({
        url : 'MicroirrigationController/getNWs',
        method : "POST",
        data : {id: id, subid:subid},
        async : true,
        dataType : 'json',
        success: function(response){             
          ...
          $.each(response,function(index,data){
            ...
            $.ajax({
                url : 'MicroirrigationController/getNW',
...
$(document).on('click','#btnClick',function(){
	$.post("MicroirrigationController/showupc",
      {get_count:true},
      function(result){
        $("#upc").val(result);
      }
